...
public class CustomCogwheelTileRenderer extends BracketedKineticTileRenderer {
    public CustomCogwheelTileRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }
