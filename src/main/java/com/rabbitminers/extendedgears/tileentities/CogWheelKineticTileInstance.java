...
public class CogWheelKineticTileInstance extends BracketedKineticTileInstance {
    public CogWheelKineticTileInstance(MaterialManager modelManager, KineticTileEntity tile) {
